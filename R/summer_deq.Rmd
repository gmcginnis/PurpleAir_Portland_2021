...
```{r data_applying}
data_deq_hourly <- group_data(data_deq, by_day = TRUE, by_hour = TRUE)
data_deq_daily <- group_data(data_deq, by_day = TRUE, by_hour = FALSE)
data_deq_diurnal <- group_data(data_deq, by_day = FALSE, by_hour = TRUE)
