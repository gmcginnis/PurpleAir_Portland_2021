...
# ggmap tiles have been acting up, but running the following chunk just once should fix it
# won't need to re-run this chunk each time
...
```{r loading_data}
# automated data loading and more viz can be found on the /R/summer_bc.Rmd file
# but this file is fully self-contained and will load the data on its own regardless of directory
