...
#OPTIONAL: filter for specific locations, e.g. for STAR labs use "*STAR*" exactly. Null otherwise
...
# OPTIONAL. caveat: do NOT rename the timestamp variable here
input_renames <- c(
...
# Output: Two data frames (one primary, one secondary)
