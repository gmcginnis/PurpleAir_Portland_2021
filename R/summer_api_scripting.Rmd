...
data_daily <- applying_functions(data_pm25)

applying_functions(data_subset, group_day = FALSE, group_hour = TRUE)
applying_functions(data_subset, group_day = TRUE, group_hour = TRUE)

applying_functions(data_subset, group_day = TRUE, group_hour = TRUE, tag_hours = TRUE, tag_dates = TRUE)

data_hourly <- applying_functions(data_pm25, group_hour = TRUE)
```

```{r,eval=FALSE}
data_subset <- data_pm25 %>% slice(1:10000)
