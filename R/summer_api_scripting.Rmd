...
apply_temperature <- function(dataset, variable = temperature, change = temperature_change) {
...
apply_corrections <- function(dataset, daily = TRUE, hourly = FALSE, epa = 75, temp_change = temperature_change){
  ...
  dataset_corrected <- full_join(epa, lrapa) %>% 
    apply_temperature(change = temp_change)
