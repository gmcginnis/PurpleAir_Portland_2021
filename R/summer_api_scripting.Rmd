...
tetsing <- function(pollutants){
  ...
  for (i in pollutants) {
    unit_results <- settings_units(dataset=data_hourly %>% slice(1), var = i, cap_color = NA, lab_title = "Blah")
  ...
  print(paste(lab_title_val, corr_final))
}

tetsing(c("temperature_ambient", "pm25_epa_2021"))
tetsing(c("temperature", "pm25_epa_2021"))
tetsing(c("pm25_atm", "pm25_epa_2021"))
tetsing("temperature")
tetsing(c("temperature", "pm25_epa_2021"))
...
ts_variation(data_daily, c("pm25_atm", "temperature"), include = "Lighthouse")
