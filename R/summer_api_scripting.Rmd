...
input_date_ends <- c("2020-07-03", "2020-07-04", "2020-07-08")
...
heatmap_cross <- function(dataset, variable_of_interest, drop_incomplete = FALSE,
  ...
  # Default plot labels
  lab_title <- expression("Heatmap of PM"[2.5]*" values across time")
  lab_subtitle <- paste("PurpleAir data from", start_date, "to", end_date)
  lab_fill <- expression(paste("Average PM"[2.5]*" (", mu, "g/m"^3*"):"))
  ...
  lab_caption <- paste0("Variable plotted: ",
...
heatmap_cross(data_hourly, variable_of_interest=epa_2021, filter_max = 50, max_color = green)
