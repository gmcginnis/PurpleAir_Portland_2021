...
if(run_dategrouping == TRUE){
  data_hourly_epa <- apply_dates(data_hourly_epa)
  data_hourly_lrapa <- apply_dates(data_hourly_lrapa)
  data_daily_epa <- apply_dates(data_daily_epa)
  data_daily_lrapa <- apply_dates(data_daily_lrapa)
...
map_q(data_daily_epa, point_size = 6)
map_q(data_daily_lrapa, point_size = 5, correction = lrapa)
```
