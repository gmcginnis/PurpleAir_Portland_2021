...
run_date_grouping <- TRUE
# Date grouping categories:
input_date_tags <- c("Before", "After")
# Start dates (in a list, "YYYY-MM-DD")
input_date_starts <- c("2021-06-01", "2021-06-15")
# End dates (in a list, "YYYY-MM-DD")
input_date_ends <- c("2021-06-14", "2021-06-30")
...
apply_epa <- function(dataset, by_day = TRUE, by_hour = FALSE, epa_percent = 75){
  ...
  print("Values to be dropped via an anti-join:")
  print(drop_set)
  ...
  dataset %>% 
    ...
    filter_at(vars(epa_2020, epa_2021), any_vars(. >= 0))
}
```
