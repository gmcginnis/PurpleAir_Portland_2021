...
map_q(data_daily, variable_of_interest = pm25_atm, grouping_vars = "date_tag", cap_value = 14)
...
heatmap_single <- function(variable_of_interest, site_of_interest,
  ...
  lab_title <- unit_results$lab_title
  lab_title_val <- unit_results$lab_title_val
  lab_subtitle <- paste0("Monitor selected: \"", dataset %>% pull(label),
  ...
  if (data_labels == TRUE) {
    ...
    #     x = date(date_hour),
    #     y = hour(date_hour),
    #     label = rounding_w_zeroes(vals, digits)
    #   ),
    #   color = {{text_color}}
    # )
...
heatmap_single(epa_2021, "Sunset", cap_value = 15)
heatmap_single(epa_2021, "Sunset")
