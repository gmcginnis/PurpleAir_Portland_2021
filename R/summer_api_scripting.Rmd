...
heatmap_single(data_hourly, "Benson 1", humidity)
...
heatmap_cross(data_hourly, variable_of_interest=epa_2021, filter_max = 50, max_color = green, drop_incomplete = TRUE)
heatmap_cross(data_daily, variable_of_interest=humidity)
